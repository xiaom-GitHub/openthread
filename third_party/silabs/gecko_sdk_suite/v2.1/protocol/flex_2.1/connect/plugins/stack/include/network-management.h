 ...
 *  scanning procedure and if this was initiated by the application with the
 ...
 *
 *  @param mean        The average energy detected.
 *  @param min         The minimum energy detected.
 *  @param max         The maximum energy detected.
 *  @param variance    The variance of the energy detected.
 */
...
/** @brief Configures the "allocate address" flag in the association request
 * command for nodes joining as ::EMBER_MAC_MODE_DEVICE or
