...
#define _PRS_CH_CTRL_SOURCESEL_RACPAEN \
  ((PRS_RAC_PAEN & _PRS_CH_CTRL_SOURCESEL_MASK) >> _PRS_CH_CTRL_SOURCESEL_SHIFT)
#define _PRS_CH_CTRL_SIGSEL_RACPAEN \
  ((PRS_RAC_PAEN & _PRS_CH_CTRL_SIGSEL_MASK) >> _PRS_CH_CTRL_SIGSEL_SHIFT)

#define _PRS_CH_CTRL_SOURCESEL_RACLNAEN \
  ((PRS_RAC_LNAEN & _PRS_CH_CTRL_SOURCESEL_MASK) >> _PRS_CH_CTRL_SOURCESEL_SHIFT)
#define _PRS_CH_CTRL_SIGSEL_RACLNAEN \
  ((PRS_RAC_LNAEN & _PRS_CH_CTRL_SIGSEL_MASK) >> _PRS_CH_CTRL_SIGSEL_SHIFT)
...
void emberAfPluginFemControlInitCallback(void)
{
  ...
  halConfigurePrs(PRS_CHANNEL_TX, PRS_LOCATION_TX, _PRS_CH_CTRL_SOURCESEL_RACPAEN, _PRS_CH_CTRL_SIGSEL_RACPAEN, EMBER_AF_PLUGIN_FEM_CONTROL_TX_CHANNEL_INVERSION);
#endif
  ...
  halConfigurePrs(PRS_CHANNEL_RX, PRS_LOCATION_RX, _PRS_CH_CTRL_SOURCESEL_RACLNAEN, _PRS_CH_CTRL_SIGSEL_RACLNAEN, EMBER_AF_PLUGIN_FEM_CONTROL_RX_CHANNEL_INVERSION);
#endif
}
