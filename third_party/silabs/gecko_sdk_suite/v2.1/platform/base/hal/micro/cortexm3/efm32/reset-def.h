...
RESET_EXT_DEF(BROWNOUT, DVDD, 0x06U, "DP ")                             // Digital Power Domain (DVDD).
RESET_EXT_DEF(BROWNOUT, DEC, 0x06U, "DEC")                              // Detector Decouple (DEC).
RESET_EXT_DEF(BROWNOUT, BACKUP_VDD_DREG, 0x07U, "BVD")                  // Backup BOD on VDD_DREG.
RESET_EXT_DEF(BROWNOUT, BACKUP_BU_VIN, 0x08U, "BVI")                    // Backup BOD on BU_VIN.
RESET_EXT_DEF(BROWNOUT, BACKUP_UNREGPOWER, 0x09U, "BUP")                // Backup BOD on unregulated power
RESET_EXT_DEF(BROWNOUT, BACKUP_REGPOWER, 0x10U, "BRP")                  // Backup BOD on regulated power.
RESET_EXT_DEF(BROWNOUT, BACKUP_MODE, 0x11U, "BM ")                      // Backup Mode
