...
#define BSP_SERIAL_APP_RTS_PIN                        (6)
#define BSP_SERIAL_APP_RTS_PORT                       (gpioPortC)
#define BSP_SERIAL_APP_RTS_LOC                        (6)

// [SERIAL]$

// $[SPIDISPLAY]

#define BSP_SPIDISPLAY_CS_PIN                         (6)
...
#define BSP_UARTNCP_RTS_PIN                           (6)
#define BSP_UARTNCP_RTS_PORT                          (gpioPortC)
#define BSP_UARTNCP_RTS_LOC                           (6)
...
#define BSP_USART0_RTS_PIN                            (6)
#define BSP_USART0_RTS_PORT                           (gpioPortC)
#define BSP_USART0_RTS_LOC                            (6)
