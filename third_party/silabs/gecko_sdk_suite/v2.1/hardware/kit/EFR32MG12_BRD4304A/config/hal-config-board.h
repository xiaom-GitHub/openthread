...
#define PORTIO_PRS_CH5_PIN                            (10)
#define PORTIO_PRS_CH5_PORT                           (gpioPortD)
#define PORTIO_PRS_CH5_LOC                            (0)

#define PORTIO_PRS_CH6_PIN                            (11)
#define PORTIO_PRS_CH6_PORT                           (gpioPortD)
#define PORTIO_PRS_CH6_LOC                            (13)
