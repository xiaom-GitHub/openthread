...
#define BSP_CLK_HFXO_FREQ                             (40000000)
...
// $[CSEN0]
#define PORTIO_CSEN0_CEXT_PIN                         (0)
#define PORTIO_CSEN0_CEXT_PORT                        (gpioPortC)
#define PORTIO_CSEN0_CEXT_LOC                         (_CSEN_SINGLECTRL_SINGLESEL_APORT1XCH0)
...
// $[LESENSE]
#define PORTIO_LESENSE_CH12_PIN                       (4)
#define PORTIO_LESENSE_CH12_PORT                      (gpioPortA)
...
// $[USART3]
#define PORTIO_USART3_RX_PIN                          (11)
#define PORTIO_USART3_RX_PORT                         (gpioPortD)
#define PORTIO_USART3_RX_LOC                          (2)

#define PORTIO_USART3_TX_PIN                          (10)
#define PORTIO_USART3_TX_PORT                         (gpioPortD)
#define PORTIO_USART3_TX_LOC                          (2)

#define BSP_USART3_RX_PIN                             (11)
#define BSP_USART3_RX_PORT                            (gpioPortD)
#define BSP_USART3_RX_LOC                             (2)

#define BSP_USART3_TX_PIN                             (10)
#define BSP_USART3_TX_PORT                            (gpioPortD)
#define BSP_USART3_TX_LOC                             (2)
...
// $[VDAC0]
#define PORTIO_VDAC0_OUT1ALT_PIN                      (12)
#define PORTIO_VDAC0_OUT1ALT_PORT                     (gpioPortD)
...
// $[Custom pin names]
#define LES_LC_SENSE_PIN                              (4)
#define LES_LC_SENSE_PORT                             (gpioPortA)

#define UIF_TOUCH0_PIN                                (0)
#define UIF_TOUCH0_PORT                               (gpioPortC)

#define UIF_TOUCH1_PIN                                (1)
#define UIF_TOUCH1_PORT                               (gpioPortC)

#define UIF_TOUCH2_PIN                                (2)
#define UIF_TOUCH2_PORT                               (gpioPortC)

#define UIF_TOUCH3_PIN                                (3)
#define UIF_TOUCH3_PORT                               (gpioPortC)

#define DAC_LC_EXCITE_PIN                             (12)
#define DAC_LC_EXCITE_PORT                            (gpioPortD)
