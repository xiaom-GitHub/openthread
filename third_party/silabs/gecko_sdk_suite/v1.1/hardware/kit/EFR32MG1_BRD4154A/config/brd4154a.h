...
// -----------------------------------------------------------------------------
/* USART0 */
#define BSP_USART0_CTS_LOC               _USART_ROUTELOC1_CTSLOC_LOC2
#define BSP_USART0_CTS_PIN               11
#define BSP_USART0_CTS_PORT              gpioPortB
#define BSP_USART0_RTS_LOC               _USART_ROUTELOC1_RTSLOC_LOC6
...
// -----------------------------------------------------------------------------
/* USART1 */
#define BSP_USART1_CLK_LOC               _USART_ROUTELOC0_CLKLOC_LOC4
#define BSP_USART1_CLK_PIN               11
#define BSP_USART1_CLK_PORT              gpioPortB
#define BSP_USART1_CS_LOC                _USART_ROUTELOC0_CSLOC_LOC18
#define BSP_USART1_CS_PIN                13
#define BSP_USART1_CS_PORT               gpioPortD
#define BSP_USART1_MISO_LOC              _USART_ROUTELOC0_RXLOC_LOC0
#define BSP_USART1_MISO_PIN              1
#define BSP_USART1_MISO_PORT             gpioPortA
#define BSP_USART1_MOSI_LOC              _USART_ROUTELOC0_TXLOC_LOC0
...
#define BSP_VCOM_RTS_PIN                 13
#define BSP_VCOM_RTS_PORT                gpioPortD
