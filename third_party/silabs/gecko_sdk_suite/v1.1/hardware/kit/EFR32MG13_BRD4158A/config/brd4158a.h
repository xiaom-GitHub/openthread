...
#define HAL_PA_SUBGIG_ENABLE   1
#define HAL_PA_SUBGIG_VOLTMODE PA_VOLTMODE_VBAT
#define HAL_PA_SUBGIG_POWER    190
#define HAL_PA_SUBGIG_OFFSET   0
#define HAL_PA_SUBGIG_RAMP     10
