...
// SDN configuration
  #define BSP_EXTDEV_SDN_PORT           gpioPortC // PC11 (BRD4155A A00 compatible)
  #define BSP_EXTDEV_SDN_PIN            11
// INT configuration
  #define BSP_EXTDEV_INT_PORT           gpioPortC // PC10 (BRD4155A A00 compatible)
  #define BSP_EXTDEV_INT_PIN            10
// nSEL configuration
  #define BSP_EXTDEV_CS_PORT            gpioPortC // PC9  (BRD4155A A00 compatible)
  #define BSP_EXTDEV_CS_PIN             9
#else//!((BRD4155A_REV & 0x0FF) == 0)
// SDN configuration
  #define BSP_EXTDEV_SDN_PORT           gpioPortD // PD12 (BRD4155A A01 compatible)
  #define BSP_EXTDEV_SDN_PIN            12
// INT configuration
  #define BSP_EXTDEV_INT_PORT           gpioPortD // PD11 (BRD4155A A01 compatible)
  #define BSP_EXTDEV_INT_PIN            11
// nSEL configuration
  #define BSP_EXTDEV_CS_PORT            gpioPortD // PD10 (BRD4155A A01 compatible)
  #define BSP_EXTDEV_CS_PIN             10
...
#define BSP_EZRADIOPRO_USART          USART1
