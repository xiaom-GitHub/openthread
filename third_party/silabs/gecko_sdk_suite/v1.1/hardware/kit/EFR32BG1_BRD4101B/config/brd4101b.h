...
#define BSP_BUTTON0_PIN      4
#define BSP_BUTTON1_PORT     gpioPortF
#define BSP_BUTTON1_PIN      5
...
#define BSP_EXTFLASH_CS_PIN         7
#define BSP_EXTFLASH_CS_PORT        gpioPortC
#define BSP_EXTFLASH_CS_LOC         _USART_ROUTELOC0_CSLOC_LOC9
#define BSP_EXTFLASH_MISO_PIN       1
#define BSP_EXTFLASH_MISO_PORT      gpioPortA
#define BSP_EXTFLASH_MISO_LOC       _USART_ROUTELOC0_RXLOC_LOC0
#define BSP_EXTFLASH_MOSI_PIN       0
#define BSP_EXTFLASH_MOSI_PORT      gpioPortA
#define BSP_EXTFLASH_MOSI_LOC       _USART_ROUTELOC0_TXLOC_LOC0
#define BSP_EXTFLASH_SCLK_PIN       11
#define BSP_EXTFLASH_SCLK_PORT      gpioPortB
#define BSP_EXTFLASH_SCLK_LOC       _USART_ROUTELOC0_CLKLOC_LOC4
#define BSP_EXTFLASH_USART          USART0
#define BSP_EXTFLASH_USART_CLK      cmuClock_USART0
...
#define BSP_VCOM_IOEXP_ENABLE 1
#define BSP_VCOM_CTS_PIN      11
#define BSP_VCOM_CTS_PORT     gpioPortB
#define BSP_VCOM_CTS_LOC      _USART_ROUTELOC1_CTSLOC_LOC2
#define BSP_VCOM_RTS_PIN      6
#define BSP_VCOM_RTS_PORT     gpioPortC
#define BSP_VCOM_RTS_LOC      _USART_ROUTELOC1_RTSLOC_LOC6
