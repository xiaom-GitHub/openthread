...
#define RETARGET_TX            USART_Tx                     /* Set TX to
                                                             * USART_Tx */
#define RETARGET_RX            USART_Rx                     /* Set RX to
                                                             * USART_Rx */
#define RETARGET_TX_LOCATION   _USART_ROUTELOC0_TXLOC_LOC0  /* Location of of
                                                            * USART TX pin */
#define RETARGET_RX_LOCATION   _USART_ROUTELOC0_RXLOC_LOC0  /* Location of of
                                                            * USART RX pin */
#define RETARGET_TXPORT        gpioPortA                    /* UART transmission
                                                             * port */
#define RETARGET_TXPIN         0                            /* UART transmission
                                                             * pin */
#define RETARGET_RXPORT        gpioPortA                    /* UART reception
                                                             * port */
#define RETARGET_RXPIN         1                            /* UART reception
                                                             * pin */
#define RETARGET_USART         1                            /* Includes
                                                             * em_usart.h */

#elif defined(RETARGET_LEUART0)
#define RETARGET_IRQ_NAME      LEUART0_IRQHandler           /* LEUART IRQ
                                                             * Handler */
...
#define RETARGET_UART          LEUART0                      /* LEUART instance
                                                             * */
#define RETARGET_TX            LEUART_Tx                    /* Set TX to
                                                             * LEUART_Tx */
#define RETARGET_RX            LEUART_Rx                    /* Set RX to
                                                             * LEUART_Rx */
#define RETARGET_TX_LOCATION   _LEUART_ROUTELOC0_TXLOC_LOC0 /* Location of of
                                                             * LEUART TX pin */
#define RETARGET_RX_LOCATION   _LEUART_ROUTELOC0_RXLOC_LOC0 /* Location of of
                                                             * LEUART RX pin */
#define RETARGET_TXPORT        gpioPortA                    /* LEUART
                                                             * transmission port
                                                             * */
#define RETARGET_TXPIN         0                            /* LEUART
                                                             * transmission pin
                                                             * */
#define RETARGET_RXPORT        gpioPortA                    /* LEUART reception
                                                             * port */
#define RETARGET_RXPIN         1                            /* LEUART reception
                                                             * pin */
#define RETARGET_LEUART        1                            /* Includes
                                                             * em_leuart.h */
