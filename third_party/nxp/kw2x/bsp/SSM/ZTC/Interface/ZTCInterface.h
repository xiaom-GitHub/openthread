...
#define gCfgSPIInterface_d               2
#define gCfgCDCInterface_d               3
...
#define gSPIInterface_d FALSE
#define gCDCInterface_d FALSE
#elif (gZtcCommInterfaceType_d == gCfgI2CInterface_d)
#define gSCIInterface_d FALSE
#define gI2CInterface_d TRUE
#define gSPIInterface_d FALSE
#define gCDCInterface_d FALSE
#elif (gZtcCommInterfaceType_d == gCfgSPIInterface_d)
#define gSCIInterface_d FALSE
#define gI2CInterface_d FALSE
#define gSPIInterface_d TRUE
#define gCDCInterface_d FALSE
#elif (gZtcCommInterfaceType_d == gCfgCDCInterface_d)
#define gSCIInterface_d FALSE
#define gI2CInterface_d FALSE
#define gSPIInterface_d FALSE
#define gCDCInterface_d TRUE
#endif
...
#if ((gI2CInterface_d && gSCIInterface_d) || (gCDCInterface_d && gSCIInterface_d) || (gI2CInterface_d && gCDCInterface_d))
  #error Only one of I2C, SCI or CDC interfaces must be active !!!
#endif


/* Select UART as default interface if none is specified */
#if ((0 == gI2CInterface_d) && (0 == gSCIInterface_d) && (0 == gCDCInterface_d)&&(0 == gSPIInterface_d))
...
#if (gZtcIncluded_d  && (!gUart1_Enabled_d) && (!gUart2_Enabled_d))
...
#if (gZtcIncluded_d  && (!gIIC_Enabled_d) )
...
#if (gZtcIncluded_d  && (!gSPI_Enabled_d) )
#error SPI module is not enabled !!!
#endif
...
#if (gZtcIncluded_d && (!gVirtualCOMPort_d) )
#error Virtual Com Port (USB/CDC) module is not enabled !!!
#endif
...
#define gSAPMessagesEnableMcps_d    FALSE
#endif
...
#ifndef gZtcNvmMonitoringEnable_c
#define gZtcNvmMonitoringEnable_c FALSE
#endif


#ifndef gZtcLpmSuport_d
#define gZtcLpmSuport_d FALSE
#endif
...
extern void ZTCQueue_QueueToTestClient(uint8_t const *const pData,
  ...
  extern void Ztc_SendWakeUpIndication(uint8_t WakeupReason);
#else
  #define Ztc_SendWakeUpIndication(WakeupReason)
#endif
...
#define ZtcMsgNVPageEraseMonitoring(pageAddress,status)
#define ZtcMsgNVWriteMonitoring(nvmTableEntryId, elementIndex, saveRestoreAll)
#define ZtcMsgNVRestoreMonitoring(nvmTableEntryId,bStart,status)
#define ZtcMsgNVVirtualPageMonitoring(bStart,status)
