...
#endif
NwkAspTbl(aspMsgTypeSetActivePromState_c, aspMsgTypeSetActivePromState_c, gZtcMsgFlagSync_c,    gUnused_c,                  gZtcMsgFmtSimple_c         )
NwkAspTbl(aspMsgTypeXcvrWriteReq_c,       aspMsgTypeXcvrWriteReq_c,       gZtcMsgFlagSync_c,    gUnused_c,                  gZtcMsgFmtSimple_c         )
NwkAspTbl(aspMsgTypeXcvrReadReq_c,        aspMsgTypeXcvrReadReq_c,        gZtcMsgFlagSync_c,    sizeof(aspXcvrReq_t),       gZtcMsgFmtAspXcvrRead_c    )
#undef NwkAspTbl
...
ZdoNlmeTbl(0x54, 0x55,        gZtcMsgFlagAsync_c,   sizeof(nlmeEnergyScanReq_t),                    gZtcMsgFmtNlmeEnergyScanReq_c  ) /* NLME-Energy-Scan.Req            */
...
#if gZtcLpmSuport_d
ZtcMsgTbl(mZtcMsgAllowDeviceToSleepReq_c,  ZtcMsgAllowDeviceToSleep)            /* ZTC-AllowDeviceToSleep.Request */
#endif 
...
ZtcMsgTbl(mZtcMsgGetNVCountersReq_c,        ZtcMsgGetNVCountersReqFunc)         /* ZTC-NVGetNvCounters.Request.         */
ZtcMsgTbl(mZtcMsgSetNVMonitoringReq_c,      ZtcMsgSetNVMonitoring)              /* ZTC-NVSetMonitoring.Request.         */
ZtcMsgTbl(mZtcMsgFormatNvmReq_c,            ZtcMsgNVFormatReq)                  /* ZTC-NVFormatReq.Request.             */
ZtcMsgTbl(mZtcMsgRestoreNvmReq_c,           ZtcMsgNVRestoreReq)                 /* ZTC-NVRestoreReq.Request.            */
...
ZtcMsgTbl(mZtcOtaSuportSetLocalFileVersionPoliciesReq_c, ZtcOtaSuportSetLocalFileVersionPoliciesFunc) 
ZtcMsgTbl(mZtcOtaSuportAbortOTAUpgradeReq_c, ZtcOtaSupportAbortOTAUpgradeFunc)
