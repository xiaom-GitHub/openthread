...
#define gZtcPacketPayloadLen_c   gMaxPacketBufferSize_c
...
#define transmit IIC_Transmit_Slave
#define isTxActive IIC_IsSlaveTxActive

#elif gSPIInterface_d

#define getByteFromRxBuffer SPI_GetByteFromBuffer
#define transmit SPI_SlaveTransmit
#define isTxActive SPI_IsSlaveTxActive

#elif gCDCInterface_d

#define getByteFromRxBuffer CDC_GetByteFromRxBuffer
#define transmit CDC_Transmit
#define isTxActive CDC_IsTxActive
