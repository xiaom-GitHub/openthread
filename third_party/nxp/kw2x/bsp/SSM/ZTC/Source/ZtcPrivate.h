...
enum {
  ...
  mZtcOtaSuportSetLocalFileVersionPoliciesReq_c   = 0x2D, /* ZTC-OTASuportSetLocalFileVersionPolicies.Request */
  ...
  mZtcMsgAllowDeviceToSleepReq_c    = 0x45, /* ZTC-AlowDeviceToSleep.Request        */
  mZtcMsgWakeUpIndication_c         = 0x46, /* ZTC-WakeUp.Indication                */
  ...
  mZtcMsgGetNVCountersReq_c         = 0xE6, /* ZTC-NVGetNvCounters.Request.         */
  mZtcMsgSetNVMonitoringReq_c       = 0xE9, /* ZTC-NVSetMonitoring.Request.         */
  mZtcMsgNVWriteMonitoring_c        = 0xEA, /* ZTC-NVWriteMonitoring.Request        */
  mZtcMsgNVPageEraseMonitoring_c    = 0xEB, /* ZTC-NVPageEraseMonitoring            */
  mZtcMsgFormatNvmReq_c             = 0xEC, /* ZTC-NVFormatReq.Request.             */
  mZtcMsgRestoreNvmReq_c            = 0xED, /* ZTC-NVRestoreReq.Request.            */
  mZtcMsgRestoreMonitoring_c        = 0xEE, /* ZTC-NVRestoreMonitoring              */
  mZtcMsgVirtualPageMonitoring_c    = 0xEF, /* ZTC-NVVirtualPageMonitoring          */
