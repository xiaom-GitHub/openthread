...
PktFromMsgFunction(mZtcPktFromMsgAspXcvrRead_c,        ZtcPktFromMsgAspXcvrRead)
#endif
...
MsgFromPktFunction(mZtcMsgFromPktNlmeEnergyScanReq_c,  ZtcMsgFromPktNlmeEnergyScanReq)
PktFromMsgFunction(mZtcPktFromMsgNlmeEnergyScanReq_c,  ZtcPktFromMsgNlmeEnergyScanReq)
#endif
#if mZtcLenCodeAndPtrFormat_d
...
#if gSAPMessagesEnableAsp_d
/* Used for AspXcvrRead.Confirm (95 1D).   */
  Fmt(gZtcMsgFmtAspXcvrRead_c,            /* name             */ \
      mZtcPktFromMsgAspXcvrRead_c,        /* pktFromMsgFunc   */ \
      gUnused_c,                          /* pktFromMsgIndex  */ \
      mZtcMsgFromPktSimple_c,             /* msgFromPktFunc   */ \
      gUnused_c)                          /* msgFromPktIndex  */
#endif
...
#if gBeeStackIncluded_d
#if gSAPMessagesEnableNlme_d
/* Used for NlmeScan.Request (96 54).  */
Fmt(gZtcMsgFmtNlmeEnergyScanReq_c,      /* name             */ \
    mZtcPktFromMsgNlmeEnergyScanReq_c,  /* pktFromMsgFunc   */ \
    gUnused_c,                          /* pktFromMsgIndex  */ \
    mZtcMsgFromPktNlmeEnergyScanReq_c,  /* msgFromPktFunc   */ \
    gUnused_c)                          /* msgFromPktIndex   */
#endif
