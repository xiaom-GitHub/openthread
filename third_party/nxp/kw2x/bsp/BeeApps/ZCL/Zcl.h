...
{
  zclAttrId_t  aAttr[6];   /* varPACKED_STRUCTlength array of attributes */
} zclCmdReadAttr_t;
...
typedef PACKED_STRUCT zclCommonAttr_tag {
#if gZclClusterOptionals_d
...
extern const zclAttrSetList_t gZclIASACEClusterAttrSetList;
...
#define gZClMaxAttrReporting_c 8
...
extern zclReportingSetup_t gZclReportingSetup[gZClMaxAttrReporting_c];
extern zclReportingClientSetup_t gZclReportingClientSetup[gZClMaxAttrReporting_c];
