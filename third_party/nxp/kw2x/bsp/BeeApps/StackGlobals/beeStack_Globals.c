...
bool_t gNwkSmartSiblingReplacement = gNwkSmartSiblingReplacement_c;
...
*/
/*
  053474r20 ZigBee Pro spec Table 4.38
...
bool_t gR20BroadcastLeaveOnZed = FALSE;
...
#if MC13226Included_d  
extern void SSP_ApsProcessIncomingFramesPATCHED(uint8_t  *pApsHeader, zbNwkAddr_t  aSrcAddress);
#endif  /* MC13226Included_d */
...
#if MC13226Included_d  
 SSP_ApsProcessIncomingFramesPATCHED(pApsHeader, aSrcAddress);
#endif  /* MC13226Included_d */
...
/************************************************************************************
* 053474r20 ZigBee Pro spec Sec. - 4.4.2.6.1 Generating and Sending the Initial
* SKKE-1 Frame. The SKKE protocol begins with the initiator device sending an SKKE-1
* frame. The SKKE-1 command frame shall be constructed as specified in subclause
* 4.4.9.1.
*
* Interface assumptions:
