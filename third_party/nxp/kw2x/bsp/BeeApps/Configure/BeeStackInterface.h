...
/*NIB Id: 0xaa */
#define NlmeGetRequest_gNwkLeaveRequestAllowed_c()        (gNibNwkLeaveRequestAllowed)
...
/* NIB Id: 0xaa*/
#define NlmeSetRequest_gNwkLeaveRequestAllowed_c(value)        (gNibNwkLeaveRequestAllowed = (value))
