...
void ZDO_StateMachineInitialState(void)
{
  ...
  */
  ...
  else if(gZDOJoinMode == gZdoStartMode_SilentStart_c)
  {
    ...
    {
	  /* We have all security information. This will prevent reseting the trust center address */
...
void ZDO_StateMachineRunningState(void)
{
  ...
  */
  ...
  {
  uint8_t indexReport = 0;
  for(indexReport=0; indexReport<gZClMaxAttrReporting_c; indexReport++)
    if(gZclReportingSetup[indexReport].sendReportMask & gZCLReportingAttrValueEnabled_c)
    {
...
void ZDO_StateMachineStopping(void)
{
  ...
  ******************************************************************************************/
  ...
  /* Disable GTS permit*/   
  {
    ...
    (void)SetPibAttributeValue(gMPibGtsPermit_c, &gtsPermit);
  }
